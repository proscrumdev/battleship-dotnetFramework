...
namespace Battleship.Ascii
{
    ...
    internal class Program
    {
        ...
        ////////////////////////////////////////////////
        // Please replace TeamA with your team name here
        ...
        static void Main()
        {
            ...
            try
            {
                TrackTelemetryEvent("ApplicationStarted");
        ...
        private static void InitializeMyFleet()
        {
            ...
            foreach (var ship in myFleet)
            {
                ...
                for (var i = 1; i <= ship.Size; i++)
                {
                    ...
                    TrackTelemetryEvent("PlacedShipPosition", "Position",input);
                }
            }
        }
        ...
        private static void TrackTelemetryEvent(string eventName)
        {
            telemetryClient.TrackEvent(eventName, CreatePropertiesDictionary(new Dictionary<string, string>()));
        }

        private static void TrackTelemetryEvent(string eventName, string propertyKey, string propertyValue)
        {
            telemetryClient.TrackEvent(eventName, CreatePropertiesDictionary(new Dictionary<string, string>() { { propertyKey, propertyValue } }));
        }
        private static void TrackTelemetryEvent(string eventName, Dictionary<string, string> properties)
        {
            telemetryClient.TrackEvent(eventName, CreatePropertiesDictionary(properties));
        }

        private static void TrackTelemetryException(Exception exception)
        {
            telemetryClient.TrackException(exception, CreatePropertiesDictionary(new Dictionary<string, string>()));
        }

        private static Dictionary<string, string> CreatePropertiesDictionary(Dictionary<string, string> properties)
        {
            properties.Add("Team", teamName);
            return properties;
        }
    }
}
